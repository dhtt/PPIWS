...
public class PPIXpressServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String LOCAL_STORAGE_PATH = "/home/trang/PPIWS/repository/uploads/" + USER_ID + "/"; // Define a data local
        ...
        if (submitType.equals("RunExample")) {

        } else if (submitType.equals("RunNormal")) {
            ...
            String ORIGINAL_NETWORK_PATH = taxonID.isEmpty() ? INPUT_PATH + FILENAME_PPI : "taxon:" + taxonID;
