...
@WebServlet(name = "PPICompareProgressReporter", value = "/PPICompareProgressReporter")

public class PPICompareProgressReporter extends HttpServlet {
        ...
        public void doPost(HttpServletRequest request, HttpServletResponse response)
                ...
                try {   
                        ...
                        context.log(USER_ID + ": PPICompareProgressReporter: ERROR:\n" + e);
                }
        }
}
