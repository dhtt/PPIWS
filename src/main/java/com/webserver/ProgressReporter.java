...
public class ProgressReporter extends HttpServlet {
        ...
        public void doPost(HttpServletRequest request, HttpServletResponse response)
                ...
                try {
                        ...
                        // TODO: REFERENCE TO REAL LOG FILE GENERATED BY PPIXPRESS
                        String LOCAL_STORAGE_PATH = "/home/trang/PPIWS/repository/uploads/" + USER_ID
                                        + "/OUTPUT/progress.log";

                                        //TODO: Delete and replace with log file from PPIXpress
                        appendStrToFile("<li>TEST</li>", LOCAL_STORAGE_PATH);
                        runProgress = Files.readString(Paths.get(LOCAL_STORAGE_PATH));
                } catch (IOException e) {
                        stopSignal = true;
                        context.log(USER_ID + ": ProgressReporter: Fail to retrieve log file");
                }
